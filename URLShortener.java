...
public class URLShortener {
	...
	private HashMap<String, String> valueMap;// url-key map to quickly chec
												// whether an url is
	...
	public static void main(String args[]) {
		URLShortener u = new URLShortener(5, "www.ShortenerURL.com/");
		...
		for (int i = 0; i < urls.length; i++) {
			System.out.println("URL:" + urls[i] + "\tShortener URL: "
					+ u.shortenURL(urls[i]));
		}
	}
}
